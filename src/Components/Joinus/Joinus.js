                    ...
                    <div className="flex justify-center items-center h-full">
                        <div className="text-center px-6 md:px-12">
                            ...
                            <p className="description text-2xl text-white mb-4">
                                Enchant your loved ones with a classic writing utensil of masterful workmanship</p>
                            <Link to="/signup">
                                <button type="button"
                                    className="inline-block px-6 py-2.5 border-2 border-white text-white hover:border-cyan-500 hover:text-cyan-900 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
